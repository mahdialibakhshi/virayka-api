...
class Zarinpal extends Payment
{
    ...
    public function __construct(){
        $zarinpal=PaymentMethods::where('name','zarinpal')->first();
        $this->merchantID=$zarinpal->merchantID;
    }
    public function send($amount, $description, $addressId)
    {
        $data = array(
        ...
        if ($err) {
            ...
            if ($result["Status"] == 100) {
                ...
                $createOrder = parent::createOrder($addressId, $result["Authority"], 'zarinpal');
