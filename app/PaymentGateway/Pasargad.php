...
class Pasargad extends AbstractPayment
{
     ...
     * @var string $action
     */
    public function __construct($redirectAddress, $certificateFile, $merchantName = null, $action = "1003", $safeMode = true)
    {
        $pasargad_config=PaymentMethods::where('name','pasargad')->first();
        $this->terminalId=$pasargad_config->terminalId;
        $this->merchantId=$pasargad_config->merchantID;
