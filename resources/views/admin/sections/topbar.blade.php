...
{{--            </a>--}}
        ...
        <!-- Nav Item - Messages -->
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link " href="{{ route('admin.ticket.index') }}" id="messagesDropdown" role="button"
                aria-haspopup="true" aria-expanded="false">
...
{{--            </div>--}}
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="{{ asset('admin/images/user.png') }}">
            </a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> خروج از پنل مدیریت </h5>
                <button class="close ml-0" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                شما در حال خروج از پنل مدیریت هستید.آیا اطمینان دارید؟
            </div>
