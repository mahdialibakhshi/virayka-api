        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="row">
                <div class="col-md-8 col-12 d-flex align-items-center">
                    <h5 class="font-weight-bold mb-3 mb-md-0">تعداد کل سفارش‌ها ({{ $orders->total() }})</h5>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-center align-center">
                    <div class="input-group input-group-md d-flex flex-row-reverse border-radius">
                        <input type="text" class="form-control form-control-sm"
                               aria-label="Sizing example input"
                               aria-describedby="inputGroup-sizing-lg" placeholder="جست و جوی کاربر و یا شماره سفارش..."
